...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    ...
    >
      ...
      components={{
        heading2: ({children})=>(
          <h2 className="text-5xl text-balance text-center font-medium md:text-7xl">{children}</h2>
        ),
      }}
      />
     <div className="grid mt-16 items-center rounded-xl border border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 backdrop:blur-sm lg:grid-cols-3 lg:py-12 lg:gap-0">
      <div>
      ...
      <PrismicNextImage field={slice.primary.image} className={clsx("opacity-90 shadow-2xl lg:col-span-2 lg:pt-0 rounded-xl",
